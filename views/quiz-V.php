    ...
    <h2>Let's play</h2>
        ...
        <div id="playContainer" class="playContainer">
            ...
            <div id="answerBox" class="answerBox">
                <button class="previewFieldEntry" name="a1" id="antwort1_richtig" onclick="storeSelectedAnswer(this)">Antwort 1</button>
                <button class="previewFieldEntry" name="a2" id="antwort2" onclick="storeSelectedAnswer(this)">Antwort 2</button>
                <button class="previewFieldEntry" name="a3" id="antwort3" onclick="storeSelectedAnswer(this)">Antwort 3</button>
                <button class="previewFieldEntry" name="a4" id="antwort4" onclick="storeSelectedAnswer(this)">Antwort 4</button>
